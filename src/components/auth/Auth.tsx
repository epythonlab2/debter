              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 pr-12 py-3 bg-slate-900/40 border border-slate-800 rounded-xl outline-none text-sm font-bold text-white focus:bg-slate-900/80 focus:border-[#1a5fb4] transition-all" 
                    required 
                  />
                  <button
                    type="button"
          ...
          <>
            ...
            {registrationComplete && successMsg ? (
              <div className="space-y-6 text-center animate-fade-in p-2">
                <div className="bg-emerald-950/30 border border-emerald-900/40 rounded-2xl p-6 backdrop-blur-xs flex flex-col items-center gap-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        ...
                        <input 
                          ...
                          className={`w-full pl-12 pr-4 py-3.5 bg-slate-900/40 border rounded-xl outline-none text-sm font-medium text-white focus:bg-slate-900/80 transition-all ${nameError ? 'border-rose-500/50 focus:border-rose-500' : 'border-slate-800 focus:border-[#1a5fb4]'}`}
                          required={isRegistering} 
                        />
                      </div>
                      {nameError && (
                        <p className="text-[11px] font-medium text-rose-400 animate-fade-in pt-0.5 tracking-wide">{nameError}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        ...
                        <input 
                          ...
                          className={`w-full pl-12 pr-4 py-3.5 bg-slate-900/40 border rounded-xl outline-none text-sm font-medium text-white focus:bg-slate-900/80 transition-all ${businessError ? 'border-rose-500/50 focus:border-rose-500' : 'border-slate-800 focus:border-[#1a5fb4]'}`}
                          required={isRegistering} 
                        />
                      </div>
                      {businessError && (
                        <p className="text-[11px] font-medium text-rose-400 animate-fade-in pt-0.5 tracking-wide">{businessError}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        ...
                        <input 
                          ...
                          className={`w-full pl-12 pr-4 py-3.5 bg-slate-900/40 border rounded-xl outline-none text-sm font-medium text-white focus:bg-slate-900/80 transition-all ${locationError ? 'border-rose-500/50 focus:border-rose-500' : 'border-slate-800 focus:border-[#1a5fb4]'}`}
                          required={isRegistering} 
                        />
                      </div>
                      {locationError && (
                        <p className="text-[11px] font-medium text-rose-400 animate-fade-in pt-0.5 tracking-wide">{locationError}</p>
                      )}
                    </div>
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className={`w-full pl-12 py-3.5 bg-slate-900/40 border rounded-xl outline-none text-sm font-bold text-white focus:bg-slate-900/80 transition-all ${localValidationError ? 'border-rose-500/50 focus:border-rose-500' : 'border-slate-800 focus:border-[#1a5fb4]'} ${checkingPhone ? 'pr-12' : 'pr-4'}`}
                      required 
                    />
                    {checkingPhone && (
                  ...
                  {localValidationError && (
                    <p className="text-[11px] font-medium text-rose-400 animate-fade-in pt-0.5 tracking-wide">{localValidationError}</p>
                  )}
                </div>
                  ...
                  <div className="space-y-2 animate-fade-in">
                    ...
                    <div className="relative group">
                      ...
                      <input 
                        ...
                        className={`w-full pl-12 pr-4 py-3.5 bg-slate-900/40 border rounded-xl outline-none text-sm font-medium text-white focus:bg-slate-900/80 transition-all ${emailError ? 'border-rose-500/50 focus:border-rose-500' : 'border-slate-800 focus:border-[#1a5fb4]'}`}
                      />
                    </div>
                    {emailError && (
                      <p className="text-[11px] font-medium text-rose-400 animate-fade-in pt-0.5 tracking-wide">{emailError}</p>
                    )}
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      placeholder="••••••••••••" 
                      className={`w-full pl-12 pr-12 py-3.5 bg-slate-900/40 border rounded-xl outline-none text-sm font-bold text-white focus:bg-slate-900/80 transition-all ${passwordErrorMsg ? 'border-rose-500/50 focus:border-rose-500' : 'border-slate-800 focus:border-[#1a5fb4]'}`}
                      required 
                    />
                    <button
                      type="button"
                  ...
                  {passwordErrorMsg && (
                    <p className="text-[11px] font-medium text-rose-400 animate-fade-in pt-0.5 tracking-wide">{passwordErrorMsg}</p>
                  )}
                </div>
